# ECMWF seasonal monthly pressure-level z925 forecast smoke test

## Purpose
Verify that the C3S seasonal monthly pressure-level archive can retrieve ECMWF system 51 z925 data for the project forecast path.
