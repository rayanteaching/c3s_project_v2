...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Smoke test for ECMWF seasonal monthly pressure-level data on C3S."
    )
    ...
    parser.add_argument("--variable", required=True, help="C3S variable name, e.g. geopotential")
    parser.add_argument("--pressure-level", required=True, help="Pressure level in hPa, e.g. 925")
