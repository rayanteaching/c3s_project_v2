...
PROJECT_ROOT = Path("/home/fibi/projects/c3s_project_v2_era5_z925")
RAW_DIR = Path("/mnt/e/last-aticol/data/raw/era5/pressure-levels/geopotential/925hPa/monthly")
...
def read_sha256_sidecar(sidecar: Path) -> tuple[str, str]:
...
def sidecar_paths(target: Path) -> tuple[Path, Path, Path]:
