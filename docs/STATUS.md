...
## Next action
1. Define the first seasonal forecast collection target and dataset order
2. Prepare the first official seasonal downloader and run metadata
3. Start the first seasonal production run on WSL
4. After WSL validation, plan transfer and downstream server use
